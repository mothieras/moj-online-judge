...
import com.moj.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<QuestionVO> getQuestionVOById(long id, HttpServletRequest request) {
        ...
        QuestionVO questionVO = questionService.getQuestionVOByIdWithCache(id, request);
        if (questionVO == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
    ...
    /**
     * 分页获取题目提交列表（除管理员和提交者外，普通用户只能看到非答案、提交代码等公开信息）
     *
